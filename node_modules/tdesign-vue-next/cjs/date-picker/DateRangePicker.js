...
var index$2 = require('../_chunks/dep-69701ddb.js');
      ...
      if (visible) {
        ...
        if (!value.value.length) {
          if (props2.range && isArray.isArray(props2.range) || props2.panelActiveDate) {
            ...
            var startRangeBounds = datePicker_utils_index.getRangeBounds(startRange);
            var endRangeBounds = datePicker_utils_index.getRangeBounds(endRange);
