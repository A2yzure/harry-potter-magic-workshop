...
var datePicker_hooks_useSelectRange = require('./useSelectRange.js');
...
function useTableData(props) {
  ...
  if (isArray.isArray(props.range)) {
    var _getRangeBounds = datePicker_utils_index.getRangeBounds(props.range),
    ...
    finalDisableDate = function finalDisableDate(date) {
      ...
      if (props.mode === "month") {
        var allowed = datePicker_hooks_useSelectRange.monthHasAnyAllowed(props.range, date.getFullYear(), date.getMonth());
        return base || !allowed;
      }
      if (props.mode === "quarter") {
        var startMonth = Math.floor(date.getMonth() / 3) * 3;
        ...
        for (var m = startMonth; m < startMonth + 3; m++) {
          if (datePicker_hooks_useSelectRange.monthHasAnyAllowed(props.range, date.getFullYear(), m)) {
            _allowed4 = true;
            break;
          }
        }
      ...
      if (props.mode === "year") {
        var _allowed5 = datePicker_hooks_useSelectRange.yearHasAnyAllowed(props.range, date.getFullYear());
