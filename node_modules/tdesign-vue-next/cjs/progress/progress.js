...
var progress_constants_index = require('./constants/index.js');
...
var index$1 = require('../_chunks/dep-260f2492.js');
var index$2 = require('../_chunks/dep-de5aac0e.js');
require('@babel/runtime/helpers/slicedToArray');
require('../_chunks/dep-47a6d229.js');
var index$3 = require('../_chunks/dep-3927c34d.js');
...
var _Progress = Vue.defineComponent({
  ...
  setup: function setup(props2) {
    ...
    var diameter = Vue.computed(function () {
      var diameterValue = progress_constants_index.CIRCLE_SIZE_PX.MEDIUM;
      if (!props2.size) {
        return diameterValue;
      }
      var SMALL = progress_constants_index.CIRCLE_SIZE.SMALL,
        LARGE = progress_constants_index.CIRCLE_SIZE.LARGE,
        MEDIUM = progress_constants_index.CIRCLE_SIZE.MEDIUM;
      switch (props2.size) {
        case SMALL:
          diameterValue = progress_constants_index.CIRCLE_SIZE_PX.SMALL;
          break;
        case MEDIUM:
          diameterValue = progress_constants_index.CIRCLE_SIZE_PX.MEDIUM;
          break;
        case LARGE:
          diameterValue = progress_constants_index.CIRCLE_SIZE_PX.LARGE;
          break;
        default:
          var customSize = Number(props2.size);
          diameterValue = !isNaN(customSize) && customSize > 0 ? customSize : progress_constants_index.CIRCLE_SIZE_PX.MEDIUM;
          break;
      }
      return diameterValue;
    });
    ...
    var circleStyle = Vue.computed(function () {
      if (props2.theme !== progress_constants_index.PRO_THEME.CIRCLE) {
        return {};
      }
      var fontSize = diameter.value * progress_constants_index.CIRCLE_FONT_SIZE_RATIO.MEDIUM;
      if (diameter.value <= progress_constants_index.CIRCLE_SIZE_PX.SMALL) {
        fontSize = diameter.value * progress_constants_index.CIRCLE_FONT_SIZE_RATIO.SMALL;
      } else if (diameter.value >= progress_constants_index.CIRCLE_SIZE_PX.LARGE) {
        fontSize = diameter.value * progress_constants_index.CIRCLE_FONT_SIZE_RATIO.LARGE;
      }
      return {
    ...
    var circleStrokeWidth = Vue.computed(function () {
      var defaultWidth = props2.size === progress_constants_index.CIRCLE_SIZE.SMALL ? 4 : 6;
    ...
    var getIconMap = Vue.computed(function () {
      return props2.theme === progress_constants_index.PRO_THEME.CIRCLE ? CIRCLE_ICONS_MAP : NORMAL_ICONS_MAP;
    });
    var getLabelContent = function getLabelContent() {
      var labelContentRender = "".concat(props2.percentage, "%");
      var status = props2.status || "";
      if (progress_constants_index.STATUS_ICON.includes(status) && props2.theme !== progress_constants_index.PRO_THEME.PLUMP) {
      ...
      _updateInfoIsOut = _asyncToGenerator__default["default"](/*#__PURE__*/_regeneratorRuntime__default["default"].mark(function _callee() {
        ...
        return _regeneratorRuntime__default["default"].wrap(function (_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!(props2.theme === progress_constants_index.PRO_THEME.PLUMP)) {
                _context.next = 3;
                break;
              }
    ...
    return function () {
      ...
      return Vue.createVNode("div", {
      ...
      }, [props2.theme === progress_constants_index.PRO_THEME.LINE && Vue.createVNode("div", {
      ...
      }, null)]), labelContent]), props2.theme === progress_constants_index.PRO_THEME.PLUMP && Vue.createVNode("div", {
        ...
        "ref": infoRef,
        "style": barStyle.value
      }, [infoIsOut.value && labelContent]), !infoIsOut.value && labelContent]), props2.theme === progress_constants_index.PRO_THEME.CIRCLE && Vue.createVNode("div", {
